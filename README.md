...
- Mod Bug: 2 BPM events on top of each other cause a fatal error that greatly limits what you can do. **Workaround:** Edit the map config manually to delete the extra event.
